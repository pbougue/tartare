...
from tartare.core.constants import DATA_FORMAT_GTFS, DATA_FORMAT_NTFS, DATA_FORMAT_GOOGLE_TRANSIT, INPUT_TYPE_URL
from tartare.core.context import Context, CoverageExportContext
from tartare.core.fetcher import HttpFetcher
from tartare.core.gridfs_handler import GridFsHandler
from tartare.core.models import PreProcess, Input
...
class FusioExport(AbstractFusioProcess):
    ...
    def save_export(self, url: str) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir_name:
            dest_full_file_name, expected_file_name = HttpFetcher().fetch(Input(type=INPUT_TYPE_URL, url=url), tmp_dir_name)
