...
from tartare.interfaces.coverage_contributor_subscription import CoverageContibutorSubscription
...
api.add_resource(CoverageContibutorSubscription, '/coverages/<string:coverage_id>/contributors',
