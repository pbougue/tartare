...
DATA_FORMAT_BY_DATA_TYPE = {
    ...
    DATA_TYPE_PUBLIC_TRANSPORT: [DATA_FORMAT_GTFS, DATA_FORMAT_TITAN, DATA_FORMAT_OBITI, DATA_FORMAT_DIRECTION_CONFIG,
...
PLATFORM_TYPE_STOP_AREA = 'stop_area'

PLATFORM_TYPE_VALUES = [
    PLATFORM_TYPE_NAVITIA,
    PLATFORM_TYPE_ODS,
    PLATFORM_TYPE_STOP_AREA,
]
