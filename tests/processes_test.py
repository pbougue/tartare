...
class TestFusioProcesses:
    ...
    def test_fusio_import_valid_dates(self, wait_for_action_terminated, fusio_get_action_id, fusio_call,
        ...
        context = CoverageContext(Job(ACTION_TYPE_COVERAGE_EXPORT))
    ...
    def test_fusio_invalid_or_empty_dates(self, get_validity_period_union, get_validity_period_valid):
        with pytest.raises(IntegrityException) as excinfo:
            ...
            fusio_import = FusioImport(CoverageContext(Job(ACTION_TYPE_COVERAGE_EXPORT)),
    ...
    def test_call_fusio_preprod(self, fusio_call, fusio_wait_for_action_terminated):
        ...
        fusio_preprod = FusioPreProd(context=CoverageContext(Job(ACTION_TYPE_COVERAGE_EXPORT)),
    ...
    def test_call_fusio_export(self, fusio_call, fusio_wait_for_action_terminated, get_export_url, save_export):
        ...
        fusio_export = FusioExport(context=CoverageContext(Job(ACTION_TYPE_COVERAGE_EXPORT)),
